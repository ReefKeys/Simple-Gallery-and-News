      ...
      <div class="main">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h2 class="module-title font-alt">Welcome to my collection</h2>
                <div class="module-subtitle font-serif large-text">Everything about Rifqi's watch collection gallery.
                </div>
              </div>
            </div>
            {{-- <div class="row">
        ...
        <section class="module pb-0" id="works">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">my collection</h2>
