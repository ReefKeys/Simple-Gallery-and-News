...
<center>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <input required type="file" accept=".jpg,.png,.jpeg" name="gambar" id="gambar">    
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input required type="text" name="deskripsi" id="deskripsi">
      </td>
    </tr>
              ...
              <div class="container">
                {{-- <div class="row"> --}}
                  <div class="text-align: center">
                    <h4 class="font-alt">Add News</h4>
                    <hr class="divider-w mb-10">

            
                    <form action="{{url('edit_berita')}}/{{$data->id}}" method="post" enctype="multipart/form-data">
                      @csrf
                      @if (Session::has('Pesan'))
                      <div class="alert alert-success">
                        {{Session::get('Pesan')}}
                      ...
                      <div class="form-group">
                        <input required class="form-control" id="gambar" type="file" accept=".jpg,.png,.jpeg" name="gambar" placeholder="Image"/>
                      </div>
                      <div class="form-group">
                        <input required value="{{$data->judul}}" class="form-control" id="judul" type="text" name="judul" placeholder="Title"/>
                      </div>
                      <div class="form-group">
                        <input required value="{{$data->deskripsi}}"" class="form-control" id="deskripsi" type="text" name="deskripsi" placeholder="Description"/>
                      </div>
                      <div class="form-group">
