                ...
                {{-- <div class="row"> --}}
                  <div class="text-align: center">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input required class="form-control" id="judul" type="text" name="judul" placeholder="Title"/>
                      </div>
                      <div class="form-group">
                        <input required class="form-control" id="deskripsi" type="text" name="deskripsi" placeholder="Description"/>
                      </div>
                      <div class="form-group">
