  ...
  @foreach ($data as $item)
    <div class="col-md-3">
      <div class="card mb-4" style="">
          <img src="data_gambar/{{$item->gambar}}" class="card-img-top" alt="..." style="height: 300px">
          <div class="card-body">
...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      {{-- <section class="home-section home-parallax home-fade home-full-height bg-dark-30" id="home" data-background="assets/images/watch_collection.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-30 titan-title-size-1">welcome to</div>
            <div class="font-alt mb-40 titan-title-size-4">rifqi's collection</div>
          </div>
        </div>
      </section> --}}
      <div class="main">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-8 col-lg-6 col-lg-offset-2">
                <div class="callout-text font-alt">
                  <h3 class="callout-title">Want to see more news about watches?</h3>
                  <p>We always update the latest news about watches</p>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-2">
                <div class="callout-btn-box"><a class="btn btn-w btn-round" href="{{url('berita')}}">Lets view News</a></div>
              </div>
            </div>
          </div>
        </section> --}}
        ...
        {{-- <section class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="assets/images/watch_collection2.jpg">
            ...
            <ul class="slides">
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                      <blockquote class="testimonial-text font-alt">jam tangan, seni yang merangkai detik-detik kehidupan.</blockquote>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
                      <div class="testimonial-author">
                        <div class="testimonial-caption font-alt">
                          <div class="testimonial-title">rifqi</div>
                          <div class="testimonial-descr">2024</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <li>
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                      <blockquote class="testimonial-text font-alt">seperti roda, waktu terus berputar, jam tangan mengajarkan kita untuk menghargai setiap detik dalam perjalanan hidup.</blockquote>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
              ...
              <li>
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                      <blockquote class="testimonial-text font-alt">jam tangan mengingatkan kita bahwa hidup adalah serangkaian momen berharga yang tak tergantikan. pilihlah waktu dengan bijak, seperti seseorang yang menciptakan jam itu dengan teliti.</blockquote>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
        ...
        <section class="module" id="news">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">latest news about watches</h2>
                <div class="module-subtitle font-serif">
                  We always provide the latest news about luxury watches from around the world.                 
                </div>
                @if (Auth::user())

                <div class="module-subtitle font-serif">
                  <a href="{{url('tambah_berita')}}">Add news</a>
            ...
            <div class="row multi-columns-row post-columns">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><img src="data_gambar/{{$item->gambar}}" alt="Blog-post Thumbnail"/></div>
                  ...
                  <div class="post-entry">
                    <p>{{Str::limit($item->deskripsi,27)}}</p>
                  </div>
                  <div class="post-more"><a class="more-link" href="{{url('berita_lengkap')}}/{{$item->id}}">Read more</a></div>

                  @if (Auth::user())
                  <div class="post-more"><a class="more-link" href="{{url('hapus_berita')}}/{{$item->id}}">Delete</a></div>
                  <div class="post-more"><a class="more-link" href="{{url('edit_berita')}}/{{$item->id}}">Edit</a></div>
                  @endif
        ...
        <footer class="footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2023&nbsp;<a href="index.html">rifqi's collection</a>, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
