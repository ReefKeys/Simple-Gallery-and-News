      ...
      <div class="main">
        ...
        <section class="module" id="news">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">my watches collection</h2>
                <div class="module-subtitle font-serif">
                  All of my watches collection.                 
                </div>
                @if (Auth::user())

                <div class="module-subtitle font-serif">
                  <a href="{{url('tambah_gallery')}}">Add Gallery</a>
            ...
            <div class="row multi-columns-row post-columns">
              ...
              @foreach ($data as $item)
                ...
                <li class="work-item illustration webdesign"><a href="">
                    <div class="work-image"><img src="data_gambar/{{$item->gambar_gallery}}" alt="Portfolio Item"/></div>
                    <div class="work-caption font-alt">
                      <h3 class="work-title">{{$item->judul_gallery}}</h3>
                      {{-- <div class="work-descr">{{Str::limit($item->deskripsi,27)}}</div> --}}
                    </div>
  
                    @if (Auth::user())
                    <div class="post-more"><a class="more-link" href="{{url('hapus_gallery')}}/{{$item->id}}">Delete</a></div>
                    <div class="post-more"><a class="more-link" href="{{url('edit_gallery')}}/{{$item->id}}">Edit</a></div>
                    @endif
